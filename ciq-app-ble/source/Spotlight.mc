...
class Spotlight extends BleDevice {
	...
	function initialize() {
		SERVICE = Ble.stringToUuid("0000fab0-9736-46e5-872a-8a46449faa91");
		READ_CHAR = Ble.stringToUuid("0000fab1-9736-46e5-872a-8a46449faa91");
		READ_DESC = Ble.cccdUuid();
		WRITE_CHAR = Ble.stringToUuid("0000fab2-9736-46e5-872a-8a46449faa91");
		SCAN_TIMEOUT = 3;
		RESCAN_DELAY = 60;
